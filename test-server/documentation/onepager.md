...
## Requirements:
### Must-haves:
	-2 tier-one documents
	-2 additional tier-two documents
### Stretch goals:
	-2 tier-one documents
	-6-8 additional tier-two documents
### Long-term goals:
	-8-10 tier-one documents
	-all additional speeches as tier-two documents
