...
<div class="w3-card w3-block-bar" style="min-height:400px">
  ...
  <div class="w3-bar w3-light-gray">
    <!--tab bar -->
    <button class="w3-bar-item w3-button w3-border-right w3-border-left w3-border-top tablink w3-light-blue" onclick="openTab("search")" id="searchbutton">By Year</button>
