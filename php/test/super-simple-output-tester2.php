...
exec("C:\'Program Files'\R\R-3.5.1\bin\RScript.exe ../r-scripts/simple-summary.R $year", $output);

$outputt = fopen ("../output/simpleoutputtest2.txt", "x+");
...
<div class="w3-content">
  ...
  <br>
  <p><b>results:</b> <?php echo $outputt   ?> </p>
</div> <!-- end w3-card -->
